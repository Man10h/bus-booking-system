...
# Prepare 1000 distinct booking payloads across schedules 4950..5000
# Each schedule has seats
payloads = []
# Schedule 4990..5000 have seats 153776..154110
seat_base = 153776
for i in range(1000):
    # cycle through schedules 4990..5000
    sched_id = 4990 + (i % 11)
    # seat id within schedule
    seat_id = seat_base + (i % 300)
    payloads.append({"scheduleId": sched_id, "scheduleSeatIds": [seat_id]})

def run_profiling_test(target_url, test_name, target_rps=100, duration_seconds=10):
    print(f"\n=======================================================")
...
if __name__ == '__main__':
    # Test 1: Direct to core-service (Port 8002)
    ...
    # Test 2: Through API Gateway (Port 8080)
